...
let morph: gsap.core.Tween

onMounted(() => {
  morph = gsap.to("#circle", { duration: 1, morphSVG: "#hippo", repeat: 1, yoyo: true, repeatDelay: 0.2 })
})
...
<template>
  <div>
    <svg version="1.1" id="svg2" inkscape:version="0.91 r13725" x="0px" y="0px" viewBox="9 80 800 400"
      style="enable-background:new 9 80 800 400;" xml:space="preserve">
  ...
  S490.1,236.19,490.1,280.649z" />
    ...
    <button class="dark-grey-button club-demo-button" id="play" @click="handlePlay">play</button>
  </div>
</template>
